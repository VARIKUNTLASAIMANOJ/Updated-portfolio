...
import { achievements, certifications, internships } from "@/lib/data";
    ...
    <div className="relative max-w-3xl mx-auto">
        ...
        {items.map((item, index) => (
            ...
            >
                ...
                <div
                    className="hidden md:block absolute top-2 w-3 h-3 bg-[var(--accent)] rounded-full z-10"
                    style={{
                ...
                <div className="pl-6 md:pl-0">
                    <span className="text-sm text-[var(--accent)] font-medium">{item.year}</span>
                    <h4 className="text-lg font-semibold text-[var(--text-primary)] mt-1 mb-1">
                        {item.title}
                    </h4>
                    {item.company && (
                        <p className="text-sm text-[var(--text-muted)] font-medium mb-2">{item.company}</p>
                    )}
            ...
            <div className="container">
                ...
                >
                    ...
                    <p className="section-subheading">
                        My internships, achievements, and milestones
                    </p>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="mb-14"
                >
                    <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-8 text-center">
                        Internships
                    </h3>
                ...
                {/* Divider */}
                <div className="border-t border-[var(--border)] max-w-3xl mx-auto mb-14" />
                ...
                >
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {certifications.map((cert, index) => (
                            ...
                            >
                                <h4 className="font-medium text-[var(--text-primary)] mb-1">{cert.name}</h4>
                                <p className="text-sm text-[var(--text-muted)]">{cert.platform}</p>
                            </motion.div>
                        ))}
                    </div>
                </motion.div>
